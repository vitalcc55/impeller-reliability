      ...
      <div className="start-view">
        <section className="start-intro" aria-labelledby="start-title">
          <div>
            ...
            <Text>
              Начните с отдельного контейнера проекта. Сейчас приложение сохраняет его идентичность,
              метаданные и неизменяемую историю действий.
            </Text>
          </div>
    ...
    <div className="project-view">
      <header className="project-heading">
        <div>
          ...
          <Text>
            {project.projectNumber || 'Номер проекта не задан'} · редакция {project.recordRevision}
          </Text>
        </div>
        <Group>
          <Button
